Feature: Context Consistency Attributes
  In order to maintain stable behavior tests
  As a feature writer
  I need a separate context for every scenario/outline using attributes
  ...
  Background:
    Given a file named "features/bootstrap/FeatureContext.php" with:
      ...
      class CoreContext
      {
          ...
          /**
           * You can always use annotations with PHP attributes until the attributes will be default.
           *
