Feature: Stringifying PHPUnit exceptions
  ...
  Scenario: With PHPUnit 9 working correctly
      ...
      001 Scenario: Compare mismatched array                             # {{PATH:features/with_phpunit_9.feature}}:6
            Then an array {"value": "foo"} should equal {"value": "bar"} # {{PATH:features/with_phpunit_9.feature}}:7
              Should get the right value
      ...
      002 Scenario: Compare mismatched ints  # {{PATH:features/with_phpunit_9.feature}}:12
            Then an integer 1 should equal 2 # {{PATH:features/with_phpunit_9.feature}}:13
              check the ints
  ...
  Scenario: With a theoretically-supported PHPUnit that causes errors during stringification
      ...
      001 Scenario: Compare mismatched array                             # {{PATH:features/with_phpunit_10_broken.feature}}:7
            Then an array {"value": "foo"} should equal {"value": "bar"} # {{PATH:features/with_phpunit_10_broken.feature}}:8
              Should get the right value
              Failed asserting that two arrays are equal.
              !! There was an error trying to render more details of this PHPUnit\Framework\ExpectationFailedException.
                 ...
                 [RuntimeException] Some internal problem at {{PATH:features/bootstrap/IncompatibleThrowableToStringMapper.php}}:9

      002 Scenario: Compare mismatched ints  # {{PATH:features/with_phpunit_10_broken.feature}}:13
            Then an integer 1 should equal 2 # {{PATH:features/with_phpunit_10_broken.feature}}:14
              check the ints
              Failed asserting that 1 is identical to 2.
              !! There was an error trying to render more details of this PHPUnit\Framework\ExpectationFailedException.
                 You are probably using a PHPUnit version that Behat cannot automatically display failures for.
    ...
    Scenario: With unsupported PHPUnit
      ...
      001 Scenario: Compare mismatched array                             # {{PATH:features/with_unknown_phpunit_version.feature}}:7
            Then an array {"value": "foo"} should equal {"value": "bar"} # {{PATH:features/with_unknown_phpunit_version.feature}}:8
              Should get the right value
              Failed asserting that two arrays are equal.
      ...
      002 Scenario: Compare mismatched ints  # {{PATH:features/with_unknown_phpunit_version.feature}}:13
            Then an integer 1 should equal 2 # {{PATH:features/with_unknown_phpunit_version.feature}}:14
              check the ints
              Failed asserting that 1 is identical to 2.
              !! Could not render more details of this PHPUnit\Framework\ExpectationFailedException.
                 Behat does not support automatically formatting assertion failures for your PHPUnit version.
